...
public abstract class AbstractRocketMqConsumer {
    ...
    protected AbstractRocketMqConsumer(String consumerGroup) {
        this.consumerGroup = consumerGroup;
    }

    protected AbstractRocketMqConsumer(String consumerGroup, String namesrvAddr) {
...
//
         ...
         */
        map.forEach((rocketMqTopic, value) -> {
            try {
                String rocketMqTags = StringUtils.join(value, " || ");
    ...
    public AbstractRocketMqConsumer setConsumerGroup(String consumerGroup) {
        this.consumerGroup = consumerGroup;
        return this;
    }
